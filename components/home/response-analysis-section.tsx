  ...
  return (
    <section className="flex h-full flex-col rounded-[2rem] border border-slate-200/70 bg-white/80 p-5 shadow-[0_18px_60px_rgba(148,113,73,0.12)] backdrop-blur sm:p-6">
      ...
      <div className="mt-5 flex flex-1 flex-col gap-4 overflow-y-auto rounded-[1.5rem] bg-gradient-to-br from-emerald-50 to-teal-100 p-4 text-slate-950 sm:p-5">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-800 sm:text-sm sm:tracking-[0.2em]">{t.analysisStrengths}</p>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-800 sm:text-sm sm:tracking-[0.2em]">{t.analysisTips}</p>
          <ul className="mt-2 list-disc pl-5 text-xs leading-5 text-slate-700 sm:text-sm sm:leading-6">
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-800 sm:text-sm sm:tracking-[0.2em]">{t.analysisVocab}</p>
          <div className="mt-2 flex flex-wrap gap-2">
            <span className="inline-block rounded-lg border border-emerald-100 bg-white px-3 py-1.5 text-xs font-medium text-emerald-900 shadow-sm">{t.analysisVocab1}</span>
            <span className="inline-block rounded-lg border border-emerald-100 bg-white px-3 py-1.5 text-xs font-medium text-emerald-900 shadow-sm">{t.analysisVocab2}</span>
          </div>
        </div>
      </div>
    </section>
